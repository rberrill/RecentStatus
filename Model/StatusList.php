...
class RecentStatus_Model_StatusList extends Xenforo_Model_User
{
	public static function getStatusArray() {
		$db = XenForo_Application::get('db');
		$userModel = new Xenforo_Model_User;
		$options = XenForo_Application::get('options');
		$numStatusShown = $options->recentStatusNumView;
		$showComments = $options->recentStatusShowComments;
		$onePerUser = $options->recentStatusOnePerUser;
		if($onePerUser == 1) {
